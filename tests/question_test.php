...
require_once($CFG->dirroot . '/question/type/mchoicef/tests/helper.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_mchoicef_question_test extends advanced_testcase {
    /**
     * Get a test question.
     *
     * @param stdObject $which
     * @return qtype_mchoicef_question the requested question object.
     */
    protected function get_test_mchoicef_question($which = null) {
        return test_question_maker::make_question('mchoicef', $which);
    }

    public function test_get_expected_data() {
        $question = $this->get_test_mchoicef_question('two_of_four');
    ...
    public function test_get_question_summary() {
        $mc = $this->get_test_mchoicef_question('two_of_four');
