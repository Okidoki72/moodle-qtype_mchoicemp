 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_mchoicef_test_helper {
    /**
    ...
    /**
     * Makes a mchoicef question with 2 correct answers.
     *
     * @return qtype_miltichoiceset_question
     */
    public function make_mchoicef_question_two_of_four() {
        question_bank::load_question_definition_classes('mchoicef');
        $mc = new qtype_mchoicef_question();
        ...
        $mc->qtype = question_bank::get_qtype('mchoicef');
        $mc->shuffleanswers = 1;
     ...
     * @return object
     */
    public static function get_mchoicef_question_data_two_of_four() {
        global $USER;
     ...
     * @return object
     */
    public static function get_mchoicef_question_form_data_two_of_four() {
        $qdata = new stdClass();
