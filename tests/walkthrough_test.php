 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_mchoicef_walkthrough_test extends qbehaviour_walkthrough_test_base {

    public function test_deferredfeedback_feedback_mchoicef() {
        // Create a mchoicef question.
        $mc = $dd = test_question_maker::make_question('mchoicef');
    ...
    public function test_deferredfeedback_resume_mchoicef_right_right() {
