...
global $CFG;
require_once($CFG->dirroot . '/question/type/mchoicef/questiontype.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_mchoicef_test extends advanced_testcase {
    protected $qtype;

    protected function setUp() {
        $this->qtype = new qtype_mchoicef();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'mchoicef');
    }
