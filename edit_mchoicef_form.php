...
class qtype_mchoicef_edit_form extends question_edit_form {
    ...
    protected function get_penalty_types() {
        $styles = array();
        foreach (array('type1', 'type2', 'type3', 'type4') as $penaltytypeoption) {
            $styles[$penaltytypeoption]
                    = get_string('penaltytype' . $penaltytypeoption, 'qtype_mchoicef');
        }
        return $styles;
    }
    protected function definition_inner($mform) {
        ...
        $mform->addElement('select', 'penaltytype',
                get_string('penaltytype', 'qtype_mchoicef'), get_penalty_types());
        $mform->setDefault('penaltytype', 'type1');
    ...
    protected function data_preprocessing($question) {
        ...
        if (!empty($question->options)) {
            ...
            $question->penaltytype = $question->options->penaltytype;
