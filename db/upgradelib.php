...
/**
 * Upgrade library code for the mchoicef question type.
 *
...
/**
 * Class to convert mchoicef question attempt data when upgrading to the new question engine.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_mchoicef_qe2_attempt_updater extends question_qtype_attempt_updater {
    ...
    public function is_blank_answer($state) {
        // Blank mchoicef answers are not empty strings, they rather end in a colon.
