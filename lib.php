 ...
 * @return bool Success
 */
function qtype_mchoicef_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
    global $CFG;
    require_once($CFG->libdir . '/questionlib.php');
    question_pluginfile($course, $context, 'qtype_mchoicef', $filearea, $args, $forcedownload, $options);
}
